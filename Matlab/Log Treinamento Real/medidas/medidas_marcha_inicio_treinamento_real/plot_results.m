...
title({'Gráfico da variação do acelerômetro no tempo', 'Marcha incial do treinamento'});
xlabel('Tempo (s)');
...
plot(time,s4);
legend('s1','s2', 's3', 's4');
title({'Gráfico da variação dos sensores de força no tempo ', 'Marcha inicial do treinamento'});
xlabel('Tempo (s)');
