...
#Resultados_treinamento:
	#resultados dos treinamentos utilizando o gamultobj. São workspaces do matlab. Em optimresults existe informações
	de score, melhores individuos das populações e melhores individuos. 	